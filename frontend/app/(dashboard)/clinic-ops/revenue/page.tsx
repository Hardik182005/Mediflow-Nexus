...
const cptProfitability = [
  { code: "99215", name: "Office Visit (Complex)", revenue: 285, cost: 95, margin: 66.7, volume: 342, color: "white" },
  { code: "99214", name: "Office Visit (Moderate)", revenue: 175, cost: 65, margin: 62.8, volume: 528, color: "white" },
  { code: "90837", name: "Psychotherapy (60min)", revenue: 220, cost: 90, margin: 59.1, volume: 186, color: "white" },
  { code: "97110", name: "Therapeutic Exercise", revenue: 95, cost: 35, margin: 63.2, volume: 415, color: "white" },
  { code: "29881", name: "Knee Arthroscopy", revenue: 8500, cost: 3200, margin: 62.4, volume: 28, color: "white" },
];
  ...
  return (
    <div className="space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: "Monthly Revenue", value: "$415K", change: 4.3, icon: DollarSign, color: "white" },
          { label: "Revenue Leakage", value: "$32.1K", change: -18.5, icon: AlertCircle, color: "white" },
          { label: "Avg Reimbursement", value: "$1,080", change: 2.1, icon: TrendingUp, color: "white" },
          { label: "Collection Rate", value: "94.2%", change: 1.8, icon: Zap, color: "white" },
        ].map((s, i) => (
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="glass-card-static p-5">
          ...
          <div className="space-y-3">
            {leakageItems.map((item, i) => (
              <div key={item.source} className="flex items-center justify-between p-3 rounded-lg bg-white/[0.03] border border-white/[0.06] border border-white/[0.04]">
                <div className="flex items-center gap-3">
